...
**To Install**<br>
For now, LuLu must be installed via the command-line. Build LuLu (or download the pre-built binaries), then execute the configuration script (`configure.sh`) with the `-install` flag, as root:
```
//install
